        ...
        <nav>
            <div>
                <a href="#" class="nav-item nav-logo">
                    <div class="logo">
                        <img src="assets/partials/logo1.png" alt="logo" height="90px" width="100px">MY Journey
                    </div>
                </a>
            ...
            <ul>
                ...
                <a href="assets/partials/cust_login.php" class="login nav-item"><i class="fas fa-sign-in-alt" style="margin-right: 0.4rem;"></i>Login</a>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                The story of modern bus reservation systems is rooted in the evolution of technology, aimed at solving inefficiencies in the public transportation sector. Initially, bus bookings were done manually at bus stations, where passengers had to physically visit ticket counters, wait in long lines, and sometimes face the disappointment of sold-out tickets, especially during peak seasons.
                </p>
            </div>
        </section>
        <section id="contact">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Bus Ticket Booking System | Made with &#10084;&#65039; love.
                        </p>
        </footer>
    </div>
