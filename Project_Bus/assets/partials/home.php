...
<body style="font-family:Arial; margin:0;">
	...
	<div class="nav" style="background-color:#141850; text-align:center;" >
      ...
      <th><img src="logo1.png" class="imgservice" width="100px" height="100px"/></th><th width="20px"></th><th  style="font-size:35px;">MY Journey</th>
		<td width="90px">
			</td>
		<td width="850px" align='center'>
			<br>
	    <a style="text-decoration: none; font-size: 25px;" href="/Project_Bus/index.php"><b>Home</b></a>
	...
	<div class="bg">
		...
		<br><br><br><br>
		<p style="padding-left: 50px; font-size: 35px;text-align: center;"><b>Welcome to MY Journey Website</b></p>
		<p style="text-align: center; font-size:20px;">Want to Book a Bus Ticket?</p>
		<br>
		<div align="center">
	         <button class="searchbtn" onclick="window.location.href='cust_view.php'"><span>Book Now</span></button>
        </div>
<script>
	</div>
	<!--div><br><br><br>
